...
template <class T, class I> class InterpTable4;
...
template <class T> class Interpolator4
{
  /** First index object. */
...
public:
  /** Constructor. */
  Interpolator4(const InterpIndex<T> &index1, const InterpIndex<T> &index2,
                const InterpIndex<T> &index3, const InterpIndex<T> &index4) :
    index1(index1),
    index2(index2),
    index3(index3),
    index4(index4),
             ...
             ((1.0 - frac2) *
              ...
              (frac2) *
                ((1.0 - frac3) *
                 ...
                 (frac3) * ((1.0 - frac4) *
                              table.getValue(idx1, idx2 + 1, idx3 + 1, idx4) +
                            (frac4)*table.getValue(idx1, idx2 + 1, idx3 + 1,
                                                   idx4 + 1)))) +
           (frac1) *
             ((1.0 - frac2) *
                ((1.0 - frac3) *
                 ...
                 (frac3) * ((1.0 - frac4) *
                              table.getValue(idx1 + 1, idx2, idx3 + 1, idx4) +
                            (frac4)*table.getValue(idx1 + 1, idx2, idx3 + 1,
                                                   idx4 + 1))) +
              (frac2) *
                ((1.0 - frac3) *
                   ((1.0 - frac4) *
                      table.getValue(idx1 + 1, idx2 + 1, idx3, idx4) +
                    (frac4)*table.getValue(idx1 + 1, idx2 + 1, idx3,
                                           idx4 + 1)) +

                 (frac3) * ((1.0 - frac4) * table.getValue(idx1 + 1, idx2 + 1,
                                                           idx3 + 1, idx4) +
                            (frac4)*table.getValue(idx1 + 1, idx2 + 1, idx3 + 1,
                                                   idx4 + 1))));
  }
};
DUECA_NS_END
