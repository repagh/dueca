...
/*      item            : @Module@.hxx
        made by         : @author@
        from template   : SimulationoduleTemplate.hxx (2026.05)
        date            : @date@
...
*/
class @Module@Mod: public dueca::SimulationModule
{
...
public: // construction and further specification
  ...
  @Module@Mod(dueca::Entity* e, const char* part, const dueca::PrioritySpec& ts);
